...
export default function FundingPage({ data, total = 0 }) {
  ...
  const progressPercentage = Math.min(Math.round((total / monthlyGoal) * 100), 100);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 bg-white p-6 md:p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100 flex flex-col justify-between space-y-6">
            ...
            <div className="space-y-1">
              ...
              <h3 className="text-xl font-black text-slate-900">Fundraising Milestone</h3>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-2">
              <div className="space-y-1">
                ...
                <p className="text-lg font-black text-emerald-600 font-mono">৳{total.toLocaleString()}</p>
              </div>
              <div className="space-y-1 border-l border-slate-100 pl-4">
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Target</p>
                <p className="text-lg font-black text-slate-800 font-mono">৳{monthlyGoal.toLocaleString()}</p>
              </div>
              <div className="space-y-1 border-l border-slate-100 pl-4">
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Remaining</p>
                <p className="text-lg font-black text-rose-500 font-mono">৳{remainingAmount.toLocaleString()}</p>
              </div>
            </div>
            ...
            <div className="space-y-2.5">
              <div className="flex justify-between items-center text-xs font-bold">
                ...
                <span className="text-rose-600 font-mono">{progressPercentage}% reached</span>
              </div>
          ...
          <div className="lg:col-span-5 bg-white p-6 md:p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-rose-100/70 flex flex-col justify-between space-y-6">
            <h3 className="text-lg font-black text-slate-900">Choose Your Contribution</h3>
